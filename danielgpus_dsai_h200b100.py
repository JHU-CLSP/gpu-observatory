#!/usr/bin/env python3
"""GPU usage dashboard for DSAI SLURM cluster — H200 / B100 partitions.
Shows idle GPUs, per-user usage, and dkhasha1 group totals.
Limits for these GPUs are tracked separately from the main dsai script.
